...
const NewUserModal: React.FC<Props> = ({ setNewUserModal, userFormData }) => {
            ...
            <div className='w-full'>
                <form className="p-2 bg-white rounded flex flex-col gap-3 ">
                    ...
                    <div className='flex items-center justify-end gap-3 '>
                        <button onClick={() => setNewUserModal(false)} className='rounded-md text-xs border shadow bg-white-700 p-2 px-4'>
                            Cancel
                        </button>
